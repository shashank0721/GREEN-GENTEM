...
class BuyHistoryDetails extends StatefulWidget {
  static const id = "/BuyHistoryDetails";
  // const ProductsDetails({Key? key}) : super(key: key);
  @override
  State<BuyHistoryDetails> createState() => _BuyHistoryDetails();
}

class _BuyHistoryDetails extends State<BuyHistoryDetails> {
  String? email = "";
  String? Url = "";
  String? maximum = "";
  String _fName = 'a';
