...
class deliverytrack extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        style: TextStyle(
          ...
          stream: db
                  ...
                  .where("PRODUCT DELIVERED", isEqualTo: false)
                  .snapshots(),
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                return values.length > 0
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.of(context)
                                    .pushNamed(LiveDeliveryTracking.id, arguments: {
                    ...
                    : Center(
                        child: Text(
                          'Once your Payment is recieved for your\nwin Delivery system will start',
