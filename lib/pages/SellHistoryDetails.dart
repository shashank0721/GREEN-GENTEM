...
class SellHistoryDetails extends StatefulWidget {
  static const id = "/SellHistoryDetails";
  // const ProductsDetails({Key? key}) : super(key: key);
  @override
  State<SellHistoryDetails> createState() => _SellHistoryDetails();
}

class _SellHistoryDetails extends State<SellHistoryDetails> {
  String? email = "";
  String? Url = "";
  String? maximum = "";
  String _fName = 'a';
  ...
  Widget build(BuildContext context) {
    ...
    var MONEY_RECIEVED = data["MONEY RECIEVED"];
    var v;
    int max = 0;
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: Text('Payment recieved : $MONEY_RECIEVED',
                          style: TextStyle(
                            color: Colors.red,
                            fontSize: 25,
                            //fontWeight: FontWeight.bold
