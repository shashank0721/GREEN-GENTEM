...
class LiveDeliveryTracking extends StatefulWidget {
  static const id = "/LiveDeliveryTracking";
  // const ProductsDetails({Key? key}) : super(key: key);
  @override
  State<LiveDeliveryTracking> createState() => _LiveDeliveryTracking();
}

class _LiveDeliveryTracking extends State<LiveDeliveryTracking> {
  String? email = "";
  String? Url = "";
  String? maximum = "";
  String _fName = 'a';
