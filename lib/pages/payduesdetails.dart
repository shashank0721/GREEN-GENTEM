...
class PayDueDetails extends StatefulWidget {
  static const id = "/PayDueDetails";
  // const ProductsDetails({Key? key}) : super(key: key);
  @override
  State<PayDueDetails> createState() => _PayDueDetails();
}

class _PayDueDetails extends State<PayDueDetails> {
  String? email = "";
  String? Url = "";
  String? maximum = "";
  String _fName = 'a';
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                                          'The money once transferred to \nGreen Gentem UPI ID by Buyer will be\ntraansferred to Seller\nonce product is shipped.',
                                          style: TextStyle(
                                            color: Colors.red,
                                            fontSize: 17.5,
                                            //fontWeight: FontWeight.bold
                ...
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(15, 10, 15, 10),
                      child: Text('Amount to be recieved : $MAXIMUM_BID INR',
                          style: TextStyle(
                              color: Colors.blue,
                              fontSize: 20,
                              fontWeight: FontWeight.bold)),
